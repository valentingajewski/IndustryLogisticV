...
namespace LSOL.UI
{
    ...
    internal sealed class ModLocalizationService
    {
        ...
        private static Dictionary<string, Dictionary<ModLanguage, string>> BuildTranslations()
        {
            ...
            Add(translations, ModTextKey.MenuOptionsSubtitle, "Language and accessibility settings", "Langue et accessibilité", "Lingua e accessibilità", "Idioma y accesibilidad", "Язык и специальные возможности", "言語とアクセシビリティ", "语言和辅助功能", "भाषा और पहुँच", "Idioma e acessibilidade", "Dil ve erişilebilirlik ayarları");
            ...
            Add(translations, ModTextKey.DetailOptions, "Adjust language and accessibility theme options.", "Ajustez la langue et les options d'accessibilité.", "Regola lingua e accessibilità.", "Ajusta idioma y accesibilidad.", "Настройте язык и доступность.", "言語とアクセシビリティを調整。", "调整语言和辅助功能。", "भाषा और एक्सेसिबिलिटी विकल्प बदलें।", "Ajuste idioma e acessibilidade.", "Dil ve erişilebilirlik seçeneklerini ayarlayın.");
