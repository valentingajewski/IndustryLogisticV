...
namespace LSOL.UI
{
    ...
    internal sealed class ModLocalizationService
    {
        ...
        private static Dictionary<string, Dictionary<ModLanguage, string>> BuildTranslations()
        {
            ...
            Add(translations, ModTextKey.DetailStartingGuides, "Starting guides are series of steps to help new players navigate in this complex mod. Enable it will add you a checklist to do at the start of your new save", "Enable the guided startup checklist for this new save.", "Enable the guided startup checklist for this new save.", "Enable the guided startup checklist for this new save.", "Enable the guided startup checklist for this new save.", "Enable the guided startup checklist for this new save.", "Enable the guided startup checklist for this new save.", "Enable the guided startup checklist for this new save.", "Enable the guided startup checklist for this new save.", "Enable the guided startup checklist for this new save.");
