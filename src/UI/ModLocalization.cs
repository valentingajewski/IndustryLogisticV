...
namespace LSOL.UI
{
    ...
    internal static partial class ModTextKey
    {
        ...
        public const string RowMaxModuleLimitPerSite = "row.maxModuleLimitPerSite";
        ...
        public const string DetailMaxModuleLimitPerSite = "detail.maxModuleLimitPerSite";
    ...
    internal sealed class ModLocalizationService
    {
        ...
        private static Dictionary<string, Dictionary<ModLanguage, string>> BuildTranslations()
        {
            ...
            Add(translations,  ModTextKey.RowMaxModuleLimitPerSite,  "Module limit per site: < {0} >",  "Module limit per site: < {0} >",  "Module limit per site: < {0} >",  "Module limit per site: < {0} >",  "Module limit per site: < {0} >",  "Module limit per site: < {0} >",  "Module limit per site: < {0} >");
            ...
            Add(translations,  ModTextKey.DetailMaxModuleLimitPerSite,  "Set the maximum total module upgrades allowed per industry site (1-10). Placements that would exceed this cap are blocked.",  "Set the maximum total module upgrades allowed per industry site (1-10). Placements that would exceed this cap are blocked.",  "Set the maximum total module upgrades allowed per industry site (1-10). Placements that would exceed this cap are blocked.",  "Set the maximum total module upgrades allowed per industry site (1-10). Placements that would exceed this cap are blocked.",  "Set the maximum total module upgrades allowed per industry site (1-10). Placements that would exceed this cap are blocked.",  "Set the maximum total module upgrades allowed per industry site (1-10). Placements that would exceed this cap are blocked.",  "Set the maximum total module upgrades allowed per industry site (1-10). Placements that would exceed this cap are blocked.");
