...
namespace LSOL.UI
{
    ...
    internal sealed class ModLocalizationService
    {
        ...
        private static Dictionary<string, Dictionary<ModLanguage, string>> BuildTranslations()
        {
            ...
            Add(translations, ModTextKey.MenuDifficultyActionsTitle, "Difficulty Templates", "Difficulty Templates", "Difficulty Templates", "Difficulty Templates", "Difficulty Templates", "Difficulty Templates", "Difficulty Templates", "Difficulty Templates", "Difficulty Templates", "Difficulty Templates");
            ...
            Add(translations, ModTextKey.MenuDifficultyTemplateLoadTitle, "Load Difficulty Template", "Load Difficulty Template", "Load Difficulty Template", "Load Difficulty Template", "Load Difficulty Template", "Load Difficulty Template", "Load Difficulty Template", "Load Difficulty Template", "Load Difficulty Template", "Load Difficulty Template");
            Add(translations, ModTextKey.MenuDifficultyTemplateLoadSubtitle, "Choose a saved full difficulty profile.", "Choose a saved full difficulty profile.", "Choose a saved full difficulty profile.", "Choose a saved full difficulty profile.", "Choose a saved full difficulty profile.", "Choose a saved full difficulty profile.", "Choose a saved full difficulty profile.", "Choose a saved full difficulty profile.", "Choose a saved full difficulty profile.", "Choose a saved full difficulty profile.");
            Add(translations, ModTextKey.MenuNewSaveSetupSubtitle, "Configure '{0}'", "Configurez '{0}' avant de commencer", "Configura '{0}' prima di iniziare", "Configura '{0}' antes de empezar", "Настройте '{0}' перед стартом", "開始前に '{0}' を設定", "开始前配置“{0}”", "शुरू करने से पहले '{0}' सेट करें", "Configure '{0}' antes de começar", "Başlamadan önce '{0}' yapılandırın");
            ...
            Add(translations, ModTextKey.RowOfficeNpcLimit, "NPC limit at office", "NPC limit at office", "NPC limit at office", "NPC limit at office", "NPC limit at office", "NPC limit at office", "NPC limit at office", "NPC limit at office", "NPC limit at office", "NPC limit at office");
            ...
            Add(translations, ModTextKey.RowDifficultyTemplatesActions, "Difficulty templates", "Difficulty templates", "Difficulty templates", "Difficulty templates", "Difficulty templates", "Difficulty templates", "Difficulty templates", "Difficulty templates", "Difficulty templates", "Difficulty templates");
            Add(translations, ModTextKey.RowDifficultyEnableAll, "Enable all", "Enable all", "Enable all", "Enable all", "Enable all", "Enable all", "Enable all", "Enable all", "Enable all", "Enable all");
            Add(translations, ModTextKey.RowDifficultyDisableAll, "Disable all", "Disable all", "Disable all", "Disable all", "Disable all", "Disable all", "Disable all", "Disable all", "Disable all", "Disable all");
            Add(translations, ModTextKey.RowDifficultySaveTemplate, "Save template", "Save template", "Save template", "Save template", "Save template", "Save template", "Save template", "Save template", "Save template", "Save template");
            Add(translations, ModTextKey.RowDifficultyLoadTemplate, "Load template", "Load template", "Load template", "Load template", "Load template", "Load template", "Load template", "Load template", "Load template", "Load template");
            Add(translations, ModTextKey.RowNoDifficultyTemplates, "No templates saved", "No templates saved", "No templates saved", "No templates saved", "No templates saved", "No templates saved", "No templates saved", "No templates saved", "No templates saved", "No templates saved");
            ...
            Add(translations, ModTextKey.RowStartingGuides, "Starting guides", "Starting guides", "Starting guides", "Starting guides", "Starting guides", "Starting guides", "Starting guides", "Starting guides", "Starting guides", "Starting guides");
            ...
            Add(translations, ModTextKey.DetailSaveGame, "Writes current progress to {0}.state.xml.", "Écrit la progression actuelle dans {0}.state.xml.", "Scrive i progressi correnti in {0}.state.xml.", "Escribe el progreso actual en {0}.state.xml.", "Записывает текущий прогресс в {0}.state.xml.", "現在の進行状況を {0}.state.xml に保存。", "将当前进度写入 {0}.state.xml。", "वर्तमान प्रगति {0}.state.xml में लिखता है।", "Grava o progresso atual em {0}.state.xml.", "Geçerli ilerlemeyi {0}.state.xml dosyasına yazar.");
            ...
            Add(translations, ModTextKey.DetailStartingGuides, "Enable the guided startup checklist for this new save.", "Enable the guided startup checklist for this new save.", "Enable the guided startup checklist for this new save.", "Enable the guided startup checklist for this new save.", "Enable the guided startup checklist for this new save.", "Enable the guided startup checklist for this new save.", "Enable the guided startup checklist for this new save.", "Enable the guided startup checklist for this new save.", "Enable the guided startup checklist for this new save.", "Enable the guided startup checklist for this new save.");
            ...
            Add(translations, ModTextKey.DetailOfficeNpcLimitDisabled, "Ignore Construction Site Cabin capacity when hiring NPCs.", "Ignore Construction Site Cabin capacity when hiring NPCs.", "Ignore Construction Site Cabin capacity when hiring NPCs.", "Ignore Construction Site Cabin capacity when hiring NPCs.", "Ignore Construction Site Cabin capacity when hiring NPCs.", "Ignore Construction Site Cabin capacity when hiring NPCs.", "Ignore Construction Site Cabin capacity when hiring NPCs.", "Ignore Construction Site Cabin capacity when hiring NPCs.", "Ignore Construction Site Cabin capacity when hiring NPCs.", "Ignore Construction Site Cabin capacity when hiring NPCs.");
            ...
            Add(translations, ModTextKey.DetailCreateSave, "Starts a fresh game as {0}.state.xml", "Démarre une nouvelle partie sous {0}.state.xml", "Avvia una nuova partita come {0}.state.xml", "Inicia una nueva partida como {0}.state.xml", "Запускает новую игру как {0}.state.xml", "{0}.state.xml として新規開始", "以 {0}.state.xml 开始新游戏", "{0}.state.xml के रूप में नई गेम शुरू करता है", "Inicia um novo jogo como {0}.state.xml", "Yeni oyunu {0}.state.xml olarak başlatır");
            ...
            Add(translations, ModTextKey.DetailDifficultyTemplatesActions, "Save the current full difficulty profile or load a saved one.", "Save the current full difficulty profile or load a saved one.", "Save the current full difficulty profile or load a saved one.", "Save the current full difficulty profile or load a saved one.", "Save the current full difficulty profile or load a saved one.", "Save the current full difficulty profile or load a saved one.", "Save the current full difficulty profile or load a saved one.", "Save the current full difficulty profile or load a saved one.", "Save the current full difficulty profile or load a saved one.", "Save the current full difficulty profile or load a saved one.");
            Add(translations, ModTextKey.DetailDifficultyTemplatesActionsLocked, "Save the current full difficulty profile here. Loading a saved template is unavailable while the active save is locked.", "Save the current full difficulty profile here. Loading a saved template is unavailable while the active save is locked.", "Save the current full difficulty profile here. Loading a saved template is unavailable while the active save is locked.", "Save the current full difficulty profile here. Loading a saved template is unavailable while the active save is locked.", "Save the current full difficulty profile here. Loading a saved template is unavailable while the active save is locked.", "Save the current full difficulty profile here. Loading a saved template is unavailable while the active save is locked.", "Save the current full difficulty profile here. Loading a saved template is unavailable while the active save is locked.", "Save the current full difficulty profile here. Loading a saved template is unavailable while the active save is locked.", "Save the current full difficulty profile here. Loading a saved template is unavailable while the active save is locked.", "Save the current full difficulty profile here. Loading a saved template is unavailable while the active save is locked.");
            Add(translations, ModTextKey.DetailDifficultyEnableAll, "Turn every boolean difficulty rule on or enforced. Economy preset, wages, and NPC route limit stay as-is.", "Turn every boolean difficulty rule on or enforced. Economy preset, wages, and NPC route limit stay as-is.", "Turn every boolean difficulty rule on or enforced. Economy preset, wages, and NPC route limit stay as-is.", "Turn every boolean difficulty rule on or enforced. Economy preset, wages, and NPC route limit stay as-is.", "Turn every boolean difficulty rule on or enforced. Economy preset, wages, and NPC route limit stay as-is.", "Turn every boolean difficulty rule on or enforced. Economy preset, wages, and NPC route limit stay as-is.", "Turn every boolean difficulty rule on or enforced. Economy preset, wages, and NPC route limit stay as-is.", "Turn every boolean difficulty rule on or enforced. Economy preset, wages, and NPC route limit stay as-is.", "Turn every boolean difficulty rule on or enforced. Economy preset, wages, and NPC route limit stay as-is.", "Turn every boolean difficulty rule on or enforced. Economy preset, wages, and NPC route limit stay as-is.");
            Add(translations, ModTextKey.DetailDifficultyDisableAll, "Turn every boolean difficulty rule off or bypassed. Economy preset, wages, and NPC route limit stay as-is.", "Turn every boolean difficulty rule off or bypassed. Economy preset, wages, and NPC route limit stay as-is.", "Turn every boolean difficulty rule off or bypassed. Economy preset, wages, and NPC route limit stay as-is.", "Turn every boolean difficulty rule off or bypassed. Economy preset, wages, and NPC route limit stay as-is.", "Turn every boolean difficulty rule off or bypassed. Economy preset, wages, and NPC route limit stay as-is.", "Turn every boolean difficulty rule off or bypassed. Economy preset, wages, and NPC route limit stay as-is.", "Turn every boolean difficulty rule off or bypassed. Economy preset, wages, and NPC route limit stay as-is.", "Turn every boolean difficulty rule off or bypassed. Economy preset, wages, and NPC route limit stay as-is.", "Turn every boolean difficulty rule off or bypassed. Economy preset, wages, and NPC route limit stay as-is.", "Turn every boolean difficulty rule off or bypassed. Economy preset, wages, and NPC route limit stay as-is.");
            ...
            Add(translations, ModTextKey.DetailDifficultySaveTemplate, "Save the current full difficulty profile as a reusable global template.", "Save the current full difficulty profile as a reusable global template.", "Save the current full difficulty profile as a reusable global template.", "Save the current full difficulty profile as a reusable global template.", "Save the current full difficulty profile as a reusable global template.", "Save the current full difficulty profile as a reusable global template.", "Save the current full difficulty profile as a reusable global template.", "Save the current full difficulty profile as a reusable global template.", "Save the current full difficulty profile as a reusable global template.", "Save the current full difficulty profile as a reusable global template.");
            Add(translations, ModTextKey.DetailDifficultyLoadTemplate, "Load a saved full difficulty profile into the current settings surface.", "Load a saved full difficulty profile into the current settings surface.", "Load a saved full difficulty profile into the current settings surface.", "Load a saved full difficulty profile into the current settings surface.", "Load a saved full difficulty profile into the current settings surface.", "Load a saved full difficulty profile into the current settings surface.", "Load a saved full difficulty profile into the current settings surface.", "Load a saved full difficulty profile into the current settings surface.", "Load a saved full difficulty profile into the current settings surface.", "Load a saved full difficulty profile into the current settings surface.");
            Add(translations, ModTextKey.DetailDifficultyNoTemplatesFound, "Save a template first to load it here.", "Save a template first to load it here.", "Save a template first to load it here.", "Save a template first to load it here.", "Save a template first to load it here.", "Save a template first to load it here.", "Save a template first to load it here.", "Save a template first to load it here.", "Save a template first to load it here.", "Save a template first to load it here.");
            Add(translations, ModTextKey.DetailDifficultyTemplateSaved, "Saved difficulty template '{0}'.", "Saved difficulty template '{0}'.", "Saved difficulty template '{0}'.", "Saved difficulty template '{0}'.", "Saved difficulty template '{0}'.", "Saved difficulty template '{0}'.", "Saved difficulty template '{0}'.", "Saved difficulty template '{0}'.", "Saved difficulty template '{0}'.", "Saved difficulty template '{0}'.");
            Add(translations, ModTextKey.DetailDifficultyTemplateOverwritten, "Overwrote difficulty template '{0}'.", "Overwrote difficulty template '{0}'.", "Overwrote difficulty template '{0}'.", "Overwrote difficulty template '{0}'.", "Overwrote difficulty template '{0}'.", "Overwrote difficulty template '{0}'.", "Overwrote difficulty template '{0}'.", "Overwrote difficulty template '{0}'.", "Overwrote difficulty template '{0}'.", "Overwrote difficulty template '{0}'.");
            Add(translations, ModTextKey.DetailDifficultyTemplateLoaded, "Loaded difficulty template '{0}'.", "Loaded difficulty template '{0}'.", "Loaded difficulty template '{0}'.", "Loaded difficulty template '{0}'.", "Loaded difficulty template '{0}'.", "Loaded difficulty template '{0}'.", "Loaded difficulty template '{0}'.", "Loaded difficulty template '{0}'.", "Loaded difficulty template '{0}'.", "Loaded difficulty template '{0}'.");
            ...
            Add(translations, ModTextKey.DetailEconomyPresetImpossible, "Industry price $1,400,000 | licence $25,000 | 55t input | 50t output | base 17 cyc/h. OmegaFactory x1.10, RecyclingCenter x1.75.", "Industry price $1,400,000 | licence $25,000 | 55t input | 50t output | base 17 cyc/h. OmegaFactory x1.10, RecyclingCenter x1.75.", "Industry price $1,400,000 | licence $25,000 | 55t input | 50t output | base 17 cyc/h. OmegaFactory x1.10, RecyclingCenter x1.75.", "Industry price $1,400,000 | licence $25,000 | 55t input | 50t output | base 17 cyc/h. OmegaFactory x1.10, RecyclingCenter x1.75.", "Industry price $1,400,000 | licence $25,000 | 55t input | 50t output | base 17 cyc/h. OmegaFactory x1.10, RecyclingCenter x1.75.", "Industry price $1,400,000 | licence $25,000 | 55t input | 50t output | base 17 cyc/h. OmegaFactory x1.10, RecyclingCenter x1.75.", "Industry price $1,400,000 | licence $25,000 | 55t input | 50t output | base 17 cyc/h. OmegaFactory x1.10, RecyclingCenter x1.75.", "Industry price $1,400,000 | licence $25,000 | 55t input | 50t output | base 17 cyc/h. OmegaFactory x1.10, RecyclingCenter x1.75.", "Industry price $1,400,000 | licence $25,000 | 55t input | 50t output | base 17 cyc/h. OmegaFactory x1.10, RecyclingCenter x1.75.", "Industry price $1,400,000 | licence $25,000 | 55t input | 50t output | base 17 cyc/h. OmegaFactory x1.10, RecyclingCenter x1.75.");
            ...
            Add(translations, ModTextKey.ValueDifficultyImpossible, "Impossible", "Impossible", "Impossibile", "Imposible", "Невозможно", "不可能", "不可能", "असंभव", "Impossível", "İmkansız");
